...
export function PurchaseOrderPDF({ po }: PurchaseOrderPDFProps) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.infoSection}>
          ...
          <View style={styles.infoColumn}>
            ...
            <Text style={styles.infoValue}>{po.dealer_name}</Text>
          </View>
          <View style={styles.infoColumn}>
        ...
        <View style={styles.totalsSection}>
          ...
          <View style={styles.grandTotalRow}>
            ...
            <Text style={styles.grandTotalValue}>{formatCurrency(po.grand_total)}</Text>
          </View>
        </View>
